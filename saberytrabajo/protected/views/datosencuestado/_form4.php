...
<td colspan="2">
<?php echo CHtml::dropDownList('Informacionlaboral[tra_act_inf_lab]', $model,
array('S' => 'Si', 'N' => 'No'),
array('empty' => 'Seleccione...', 'style'=>'width:280px;','class'=>'clear-error'));
?>
...
<tr>
<td>
<?php echo CHtml::dropDownList('Informacionlaboral[sec_tra_inf_lab]', $model,
...
<td colspan="2">
<?php echo CHtml::dropDownList('Informacionlaboral[tip_ins_inf_lab]', $model,
...
<td colspan="2">
<?php echo CHtml::dropDownList('Informacionlaboral[fue_ing_inf_lab]', $model,
array('HP' => 'Honorarios Profesionales', 'P' => 'Pension del IVSS','S'=>'Salarios',
'II' => 'Ingresos Independientes','R'=>'Rentas'
),
array('style'=>'width:280px;height: 120px;', 'multiple' => 'multiple','class'=>'clear-error'));
?>
</td>
</tr>
<tr>
