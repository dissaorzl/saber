...
{
$dataProvider=new CActiveDataProvider('Informacionlaboral');
...
$model->attributes=$_GET['Informacionlaboral'];
...
{
$model=Informacionlaboral::model()->findByPk($id);
if($model===null)
...
* @param Informacionlaboral $model the model to be validated
*/
protected function performAjaxValidation($model)
{
if(isset($_POST['ajax']) && $_POST['ajax']==='informacionlaboral-form')
{
