...
class ProyectoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Proyecto']))
		{
			...
			if($model->save())
			{
				...
				$this->redirect(array('view','id'=>$model->cod_pro));
			}
	...
	public function actionMunicipios()
	{
		$data = Municipal::model()->findAll('cod_estado=:parent_id',
				array(':parent_id'=> $_POST['Proyecto']['cod_edo']));
	...
	public function actionParroquia()
	{
		$data = Parroquial::model()->findAll('ci_munici=:parent_id',
				array(
						':parent_id'=> $_POST['Proyecto']['cod_mun']
				)
		);
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Proyecto']))
		{
			...
			if($model->save())
			{
				$model->registraGeometria($model->lon_pro, $model->lat_pro, $model->cod_pro, 'U');
				$this->redirect(array('view','id'=>$model->cod_pro));
			}
